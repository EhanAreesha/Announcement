...
export class AnnouncementCreateComponent {
    ...
    ngOnInit() {
        ...
        if(this.icreateUpdate.announcementId != null) {
            this._announcementService.getEditedData().subscribe((data: IAnnouncements) => {
                 this.icreateUpdate.announcement = data;
                 this.icreateUpdate.buttonText = 'Edit';
            });
        } else {
            this.icreateUpdate.buttonText = 'Save';
            this.icreateUpdate.announcement = {title: "", body: "", summary: "", isFeatured: false, image: ""}
        }
    }
    ...
    initObject() {
        this.icreateUpdate = {};
        this.icreateUpdate.buttonText = 'Save';
        this.icreateUpdate.announcement = {title: "", body: "", summary: "", isFeatured: false, expiryDate: "", image: ""}
    }
    ...
    onBasicUpload(image:any) {
        ...
        reader.addEventListener('load', (event: any) => {
            ...
            this.icreateUpdate.announcement.image = this.icreateUpdate.imageSnippet.src;
        });
